...
`slides/Slides_MIC_Introduction.pdf` — 54 slides. The first ~16
slides set context and prereqs; the rest (from "Signals, Images") are
the actual content.
...
- `notebooks/02_probability_refresher.ipynb` — simulate Gaussian and
  ...
  worked example on slides 10–12 of `Slides_MIC_ImageModeling.pdf`).
