...
- Audience: **interdisciplinary undergraduates** You do not need a
- deep ML background. You **do** need
...
├── week_1/   Image basics + math foundations
├── week_2/   Statistical priors (MRF/Gibbs) + image denoising
├── week_3/   Inverse problems + CT & MRI physics
├── week_4/   Shape analysis + classical segmentation
├── week_5/   CNNs for medical images
├── week_6/   VAEs + GANs (deep generative modelling)
...
| Calendar | Folder(s) | Topics |
|---|---|---|
| Week 1 – 1.5 | `week_1/` | Image basics, probability & math foundations |
| Week 1.5 – 3 | `week_2/`, `week_3/` | Denoising, reconstruction (Bayesian inverse problems) |
| Week 3 | `week_3/` (CT+MRI half) | CT and MRI fundamentals (physics + modelling) |
| Week 4 | `week_4/` | Shape analysis, classical segmentation |
| Week 5 – 6.5 | `week_5/`, `week_6/` | CNNs for images, then VAEs and GANs |
| Week 6.5 – 8 | `week_7/`, `week_8/` | Paper reading, guided implementation, final project |
...
Run `week_1/notebooks/01_image_basics_and_io.ipynb`. If the first cell
